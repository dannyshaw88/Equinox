...
function TheoriesTab({ forTab, primaryEntries, banEntries, automatedEntries, captchaEntries, lockedEntries }: {
  ...
  return (
    <div className="space-y-4">
      {/* ── The Rules — pinned at top of every Theories tab ── */}
      <div className="border border-emerald-300 dark:border-emerald-700 rounded-lg overflow-hidden bg-emerald-50/60 dark:bg-emerald-950/30">
        <div className="px-4 py-3 border-b border-emerald-200 dark:border-emerald-800 flex items-center gap-2">
          ...
          <div className="flex-1 min-w-0">
            <span className="text-sm font-bold text-emerald-800 dark:text-emerald-200">The Rules</span>
            <p className="text-[11px] text-emerald-700 dark:text-emerald-400 mt-0.5">Non-negotiable rules for account survival — confirmed findings and active experiments from the dataset.</p>
          </div>
        </div>
        <div className="divide-y divide-emerald-100 dark:divide-emerald-900">
          <div className="px-4 py-3 flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[12px] font-semibold text-foreground">API calls and actions — minimum 125s–250s between each. Anything faster causes a delayed ban.</p>
              <span className="inline-block mt-1.5 text-[10px] font-bold uppercase tracking-wide text-emerald-700 dark:text-emerald-400 bg-emerald-100 dark:bg-emerald-900/50 px-2 py-0.5 rounded-full">Confirmed</span>
            </div>
          </div>
          <div className="px-4 py-3 flex items-start gap-3">
            <span className="text-base mt-0.5 shrink-0">✅</span>
            <div className="flex-1 min-w-0">
              <p className="text-[12px] font-semibold text-foreground">Sessions — minimum 150–250 mins between each Human Session.</p>
              <span className="inline-block mt-1.5 text-[10px] font-bold uppercase tracking-wide text-emerald-700 dark:text-emerald-400 bg-emerald-100 dark:bg-emerald-900/50 px-2 py-0.5 rounded-full">Confirmed</span>
            </div>
          </div>
          <div className="px-4 py-3 flex items-start gap-3">
            <span className="text-base mt-0.5 shrink-0">✅</span>
            <div className="flex-1 min-w-0">
              <p className="text-[12px] font-semibold text-foreground">Any heavy endpoint, or exceeding the call budget for your TrustScore — instant ban, no delay. (e.g. any autofollow action, or 2 FetchConfig calls)</p>
              <span className="inline-block mt-1.5 text-[10px] font-bold uppercase tracking-wide text-emerald-700 dark:text-emerald-400 bg-emerald-100 dark:bg-emerald-900/50 px-2 py-0.5 rounded-full">Confirmed</span>
            </div>
          </div>
          <div className="px-4 py-3 flex items-start gap-3">
            <span className="text-base mt-0.5 shrink-0">🟠</span>
            <div className="flex-1 min-w-0">
              <p className="text-[12px] font-semibold text-foreground">400 API calls before the first follow — required to move up to the next TrustScore.</p>
              <span className="inline-block mt-1.5 text-[10px] font-bold uppercase tracking-wide text-orange-700 dark:text-orange-400 bg-orange-100 dark:bg-orange-900/50 px-2 py-0.5 rounded-full">Being tested</span>
            </div>
          </div>
        </div>
      </div>
